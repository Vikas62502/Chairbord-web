...
const Checkout = () => {
  ...
  return (
    <div className="min-h-[70vh] max-w-xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center">Topup Wallet</h1>
      ...
      <div className="space-y-4 bg-white p-6 rounded-xl shadow-md border border-gray-100">
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#582898] focus:border-[#582898]"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {RECOMMENDED_AMOUNTS.map((value) => (
            <button
              ...
              className="border border-[#582898] text-[#582898] rounded-md px-4 py-2 text-sm font-medium hover:bg-[#582898]/5"
            >
              ₹{value}
            </button>
          ))}
